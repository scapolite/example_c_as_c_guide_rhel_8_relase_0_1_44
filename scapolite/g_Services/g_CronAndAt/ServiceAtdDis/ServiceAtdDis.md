  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-service_atd_disabled_ocil:questionnaire:1
        href: service_atd_disabled.ocil.xml
crossrefs:
...
The
`atd` service could be used by an unsophisticated insider to carry out
...
The
`at` and `batch` commands can be used to schedule tasks that are meant
to be executed only once. This allows delayed execution in a manner
