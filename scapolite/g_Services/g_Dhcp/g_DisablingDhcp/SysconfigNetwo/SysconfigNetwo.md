...
scapolite:
    class: rule
    version: '0.51'
id: sysconfig_networking_bootproto_ifcfg
  ...
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-sysconfig_networking_bootproto_ifcfg:def:1
        href: sysconfig_networking_bootproto_ifcfg.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-sysconfig_networking_bootproto_ifcfg_ocil:questionnaire:1
        href: sysconfig_networking_bootproto_ifcfg.ocil.xml
crossrefs:
...
DHCP
relies on trusting the local network. If the local network is not
...
For
each interface on the system (e.g. eth0), edit
