...
The
DHCPDECLINE message can be sent by a DHCP client to indicate that it
...
Edit
`/etc/dhcp/dhcpd.conf` and add or correct the following global option to
prevent the DHCP server from responding the DHCPDECLINE messages, if
possible:
