  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:redhat:anaconda:pre
        href: service_kdump_disabled.anaconda
checks:
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-service_kdump_disabled_ocil:questionnaire:1
        href: service_kdump_disabled.ocil.xml
crossrefs:
...
Kernel
core dumps may contain the full contents of system memory at the time of
the crash. Kernel core dumps consume a considerable amount of disk space
and may result in denial of service by exhausting the available space on
the target file system partition. Unless the system is used for kernel
