  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-service_qpidd_disabled_ocil:questionnaire:1
        href: service_qpidd_disabled.ocil.xml
crossrefs:
...
The
qpidd service is automatically installed when the \"base\" package
...
The
`qpidd` service provides high speed, secure, guaranteed delivery
