  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-service_rhsmcertd_disabled_ocil:questionnaire:1
        href: service_rhsmcertd_disabled.ocil.xml
crossrefs:
...
The
Red Hat Subscription Manager (rhsmcertd) periodically checks for changes
in the entitlement certificates for a registered system and updates it
accordingly. The `rhsmcertd` service can be disabled with the following
command:
