  ...
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-cups_disable_printserver:def:1
        href: cups_disable_printserver.oval.xml
crossrefs:
...
By
default, locally configured printers will not be shared over the
...
To
prevent remote users from potentially connecting to and using locally
...
printers while still allowing local users on the system to print
normally.
