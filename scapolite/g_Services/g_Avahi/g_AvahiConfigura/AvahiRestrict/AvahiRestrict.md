...
scapolite:
    class: rule
    version: '0.51'
id: avahi_restrict_published_information
...
These
options prevent publishing attempts from succeeding, and can be applied
even if publishing is disabled entirely via disable-publishing.
...
If
it is necessary to publish some information to the network, it should
