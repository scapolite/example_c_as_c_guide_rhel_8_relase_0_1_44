  ...
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-ldap_client_tls_cacertpath:def:1
        href: ldap_client_tls_cacertpath.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-ldap_client_tls_cacertpath_ocil:questionnaire:1
        href: ldap_client_tls_cacertpath.ocil.xml
crossrefs:
...
The
tls\_cacertdir or tls\_cacertfile directives are required when
...
Ensure
a copy of a trusted CA certificate has been placed in the file
