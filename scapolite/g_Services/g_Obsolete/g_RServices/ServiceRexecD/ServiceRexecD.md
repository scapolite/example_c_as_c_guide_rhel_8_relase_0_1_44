  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-service_rexec_disabled_ocil:questionnaire:1
        href: service_rexec_disabled.ocil.xml
crossrefs:
...
The
rexec service uses unencrypted network communications, which means that
...
`/etc/xinetd.d/rexec`. The `rexec` socket can be disabled with the
following command:
