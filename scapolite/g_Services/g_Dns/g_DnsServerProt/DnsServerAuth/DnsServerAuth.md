...
scapolite:
    class: rule
    version: '0.51'
id: dns_server_authenticate_zone_transfers
...
The
BIND transaction signature (TSIG) functionality allows primary and
...
If
it is necessary for a secondary nameserver to receive zone data via zone
transfer from the primary server, follow the instructions here. Use
