  ...
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-ntpd_specify_remote_server:def:1
        href: ntpd_specify_remote_server.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-ntpd_specify_remote_server_ocil:questionnaire:1
        href: ntpd_specify_remote_server.ocil.xml
crossrefs:
...
To
specify a remote NTP server for time synchronization, edit the file
