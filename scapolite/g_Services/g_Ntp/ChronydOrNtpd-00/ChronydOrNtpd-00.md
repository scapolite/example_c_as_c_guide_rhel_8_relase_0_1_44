...
scapolite:
    class: rule
    version: '0.51'
id: chronyd_or_ntpd_specify_multiple_servers
  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: chronyd_or_ntpd_specify_multiple_servers.sh
crossrefs:
...
Additional NTP servers can be specified for time synchronization. To do
...
Add additional lines of the following form, substituting the IP address
