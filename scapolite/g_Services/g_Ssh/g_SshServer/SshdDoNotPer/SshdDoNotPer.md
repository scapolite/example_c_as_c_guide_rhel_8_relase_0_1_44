  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: sshd_do_not_permit_user_env.sh
  - relative_id: '02'
    title: Automated fix
    automations:
      - system: urn:xccdf:fix:script:ansible
        href: sshd_do_not_permit_user_env.ansible
        complexity: low
        disruption: low
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-sshd_do_not_permit_user_env:def:1
        href: sshd_do_not_permit_user_env.oval.xml
        exports:
  ...
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-sshd_do_not_permit_user_env_ocil:questionnaire:1
        href: sshd_do_not_permit_user_env.ocil.xml
crossrefs:
...
SSH
environment options potentially allow users to bypass access restriction
in some configurations.

## /description

To
ensure users are not able to override environment options to the SSH
