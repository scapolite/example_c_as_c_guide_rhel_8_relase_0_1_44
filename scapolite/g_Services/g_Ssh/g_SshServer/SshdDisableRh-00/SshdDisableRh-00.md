  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: sshd_disable_rhosts.sh
  - relative_id: '02'
    title: Automated fix
    automations:
      - system: urn:xccdf:fix:script:ansible
        href: sshd_disable_rhosts.ansible
        complexity: low
        disruption: low
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-sshd_disable_rhosts:def:1
        href: sshd_disable_rhosts.oval.xml
        exports:
  ...
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-sshd_disable_rhosts_ocil:questionnaire:1
        href: sshd_disable_rhosts.ocil.xml
crossrefs:
...
SSH
can emulate the behavior of the obsolete rsh command in allowing users
