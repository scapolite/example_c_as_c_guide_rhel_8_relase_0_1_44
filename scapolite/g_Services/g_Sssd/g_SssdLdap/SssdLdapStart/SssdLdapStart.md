  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: sssd_ldap_start_tls.sh
  - relative_id: '02'
    title: Automated fix
    automations:
      - system: urn:xccdf:fix:script:ansible
        href: sssd_ldap_start_tls.ansible
        complexity: low
        disruption: medium
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-sssd_ldap_start_tls:def:1
        href: sssd_ldap_start_tls.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-sssd_ldap_start_tls_ocil:questionnaire:1
        href: sssd_ldap_start_tls.ocil.xml
crossrefs:
...
unauthorized users without detection. The ssl directive specifies
whether to use TLS or not. If not specified it will default to no. It
should be set to start\_tls rather than doing LDAP over SSL.

## /description

This
check verifies that Red Hat Enterprise Linux 8 implements cryptography
