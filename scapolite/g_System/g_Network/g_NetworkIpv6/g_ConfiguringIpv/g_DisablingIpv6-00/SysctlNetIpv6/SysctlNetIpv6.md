  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-sysctl_net_ipv6_conf_all_forwarding_ocil:questionnaire:1
        href: sysctl_net_ipv6_conf_all_forwarding.ocil.xml
crossrefs:
...
IP
forwarding permits the kernel to forward packets from one network
...
To
set the runtime status of the `net.ipv6.conf.all.forwarding` kernel
