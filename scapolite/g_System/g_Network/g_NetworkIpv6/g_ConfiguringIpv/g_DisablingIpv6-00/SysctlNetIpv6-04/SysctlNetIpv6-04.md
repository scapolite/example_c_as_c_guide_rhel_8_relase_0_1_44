  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-sysctl_net_ipv6_conf_default_accept_ra_ocil:questionnaire:1
        href: sysctl_net_ipv6_conf_default_accept_ra.ocil.xml
crossrefs:
...
An
illicit router advertisement message could result in a man-in-the-middle
attack.

## /description

To
set the runtime status of the `net.ipv6.conf.default.accept_ra` kernel
