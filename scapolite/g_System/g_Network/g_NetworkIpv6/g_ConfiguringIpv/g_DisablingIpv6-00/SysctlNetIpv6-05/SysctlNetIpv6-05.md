...
title: |
    Configure Kernel Parameter for Accepting IPv6 Source-Routed Packets for
    All Interfaces
rule: <see below>
rationale: <see below>
  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-sysctl_net_ipv6_conf_all_accept_source_route_ocil:questionnaire:1
        href: sysctl_net_ipv6_conf_all_accept_source_route.ocil.xml
crossrefs:
...
To
set the runtime status of the `net.ipv6.conf.all.accept_source_route`
