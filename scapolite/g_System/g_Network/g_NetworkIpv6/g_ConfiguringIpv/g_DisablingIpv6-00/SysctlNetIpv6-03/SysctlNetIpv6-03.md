  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-sysctl_net_ipv6_conf_all_accept_ra_ocil:questionnaire:1
        href: sysctl_net_ipv6_conf_all_accept_ra.ocil.xml
crossrefs:
...
To
set the runtime status of the `net.ipv6.conf.all.accept_ra` kernel
