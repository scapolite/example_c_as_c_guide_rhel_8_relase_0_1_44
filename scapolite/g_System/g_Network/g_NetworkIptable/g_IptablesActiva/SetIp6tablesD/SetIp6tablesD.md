  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-set_ip6tables_default_rule_ocil:questionnaire:1
        href: set_ip6tables_default_rule.ocil.xml
crossrefs:
...
In
`ip6tables`, the default policy is applied only after all the applicable
...
To
set the default policy to DROP (instead of ACCEPT) for the built-in
