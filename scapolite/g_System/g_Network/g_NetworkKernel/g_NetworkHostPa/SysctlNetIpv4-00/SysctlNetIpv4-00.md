  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-sysctl_net_ipv4_conf_all_send_redirects_ocil:questionnaire:1
        href: sysctl_net_ipv4_conf_all_send_redirects.ocil.xml
crossrefs:
...
To
set the runtime status of the `net.ipv4.conf.all.send_redirects` kernel
