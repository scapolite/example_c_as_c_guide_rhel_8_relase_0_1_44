  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-sysctl_net_ipv4_ip_forward_ocil:questionnaire:1
        href: sysctl_net_ipv4_ip_forward.ocil.xml
crossrefs:
...
topology information with other routers. If this capability is used when
not required, system network information may be unnecessarily
transmitted across the network.

## /description

To
set the runtime status of the `net.ipv4.ip_forward` kernel parameter,
