...
title: |
    Configure Kernel Parameter for Accepting ICMP Redirects for All
    Interfaces
rule: <see below>
rationale: <see below>
  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-sysctl_net_ipv4_conf_all_accept_redirects_ocil:questionnaire:1
        href: sysctl_net_ipv4_conf_all_accept_redirects.ocil.xml
crossrefs:
...
route exists for a particular destination. These messages modify the
...
To
set the runtime status of the `net.ipv4.conf.all.accept_redirects`
