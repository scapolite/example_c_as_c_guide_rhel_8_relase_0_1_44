  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-sysctl_net_ipv4_icmp_echo_ignore_broadcasts_ocil:questionnaire:1
        href: sysctl_net_ipv4_icmp_echo_ignore_broadcasts.ocil.xml
crossrefs:
...
Responding
to broadcast (ICMP) echoes facilitates network mapping and provides a
...
To
set the runtime status of the `net.ipv4.icmp_echo_ignore_broadcasts`
