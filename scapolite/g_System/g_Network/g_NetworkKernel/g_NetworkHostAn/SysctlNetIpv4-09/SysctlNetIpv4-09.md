...
title: |
    Configure Kernel Parameter for Accepting Source-Routed Packets By
    Default
rule: <see below>
rationale: <see below>
  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-sysctl_net_ipv4_conf_default_accept_source_route_ocil:questionnaire:1
        href: sysctl_net_ipv4_conf_default_accept_source_route.ocil.xml
crossrefs:
...
uses. It should be disabled unless it is absolutely required, such as
when IPv4 forwarding is enabled and the system is legitimately
