  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-sysctl_net_ipv4_conf_default_log_martians_ocil:questionnaire:1
        href: sysctl_net_ipv4_conf_default_log_martians.ocil.xml
crossrefs:
...
The
presence of \"martian\" packets (which have impossible addresses) as
well as spoofed packets, source-routed packets, and redirects could be a
...
To
set the runtime status of the `net.ipv4.conf.default.log_martians`
