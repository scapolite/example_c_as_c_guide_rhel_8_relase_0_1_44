...
title: |
    Configure Kernel Parameter for Accepting IPv4 Source-Routed Packets for
    All Interfaces
rule: <see below>
rationale: <see below>
  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-sysctl_net_ipv4_conf_all_accept_source_route_ocil:questionnaire:1
        href: sysctl_net_ipv4_conf_all_accept_source_route.ocil.xml
crossrefs:
...
only to the forwarding of source-routerd traffic, such as when IPv4
...
To
set the runtime status of the `net.ipv4.conf.all.accept_source_route`
