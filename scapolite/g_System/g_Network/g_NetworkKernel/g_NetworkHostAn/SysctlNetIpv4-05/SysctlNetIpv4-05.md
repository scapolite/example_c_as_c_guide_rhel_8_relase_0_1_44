  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-sysctl_net_ipv4_icmp_ignore_bogus_error_responses_ocil:questionnaire:1
        href: sysctl_net_ipv4_icmp_ignore_bogus_error_responses.ocil.xml
crossrefs:
...
Ignoring
bogus ICMP error responses reduces log size, although some activity
would not be logged.
