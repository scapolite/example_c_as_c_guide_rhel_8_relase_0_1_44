  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-sysctl_net_ipv4_tcp_syncookies_ocil:questionnaire:1
        href: sysctl_net_ipv4_tcp_syncookies.ocil.xml
crossrefs:
...
A
TCP SYN flood attack can cause a denial of service by filling a
...
To
set the runtime status of the `net.ipv4.tcp_syncookies` kernel
