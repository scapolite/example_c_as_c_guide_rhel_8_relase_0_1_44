  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-rsyslog_files_groupownership_ocil:questionnaire:1
        href: rsyslog_files_groupownership.ocil.xml
crossrefs:
...
The
log files generated by rsyslog contain valuable information regarding
system configuration, user authentication, and other such information.
Log files should be protected from unauthorized access.

## /description

The
group-owner of all log files written by `rsyslog` should be ``. These
