...
scapolite:
    class: rule
    version: '0.51'
id: rsyslog_accept_remote_messages_udp
...
Many
devices, such as switches, routers, and other Unix-like systems, may
only support the traditional syslog transmission over UDP. If the system
must act as a log server, this enables it to receive their messages as
well.
