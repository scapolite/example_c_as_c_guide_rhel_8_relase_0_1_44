...
scapolite:
    class: rule
    version: '0.51'
id: cracklib_accounts_password_pam_dcredit
  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-cracklib_accounts_password_pam_dcredit_ocil:questionnaire:1
        href: cracklib_accounts_password_pam_dcredit.ocil.xml
crossrefs:
...
Requiring
digits makes password guessing attacks more difficult by ensuring a
larger search space.

## /description

The
pam\_cracklib module\'s `dcredit` parameter controls requirements for
