  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: set_password_hashing_algorithm_logindefs.sh
  - relative_id: '02'
    title: Automated fix
    automations:
      - system: urn:xccdf:fix:script:ansible
        href: set_password_hashing_algorithm_logindefs.ansible
        complexity: low
        disruption: low
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-set_password_hashing_algorithm_logindefs:def:1
        href: set_password_hashing_algorithm_logindefs.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-set_password_hashing_algorithm_logindefs_ocil:questionnaire:1
        href: set_password_hashing_algorithm_logindefs.ocil.xml
crossrefs:
