  ...
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-sudo_remove_nopasswd:def:1
        href: sudo_remove_nopasswd.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-sudo_remove_nopasswd_ocil:questionnaire:1
        href: sudo_remove_nopasswd.ocil.xml
crossrefs:
...
using sudo without having to authenticate. This should be disabled by
making sure that the `NOPASSWD` tag does not exist in `/etc/sudoers`
