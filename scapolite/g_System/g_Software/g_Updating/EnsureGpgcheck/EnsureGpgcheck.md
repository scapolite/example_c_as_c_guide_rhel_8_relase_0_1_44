  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: ensure_gpgcheck_globally_activated.sh
  - relative_id: '02'
    title: Automated fix
    automations:
      - system: urn:xccdf:fix:script:ansible
        href: ensure_gpgcheck_globally_activated.ansible
        complexity: low
        disruption: medium
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-ensure_gpgcheck_globally_activated:def:1
        href: ensure_gpgcheck_globally_activated.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-ensure_gpgcheck_globally_activated_ocil:questionnaire:1
        href: ensure_gpgcheck_globally_activated.ocil.xml
crossrefs:
...
Changes
to any software components can have significant effects on the overall
...
This ensures the software has not been tampered with and that it has
been provided by a trusted vendor. Self-signed certificates are
disallowed by this requirement. Certificates used to verify the software
must be from an approved Certificate Authority (CA).
