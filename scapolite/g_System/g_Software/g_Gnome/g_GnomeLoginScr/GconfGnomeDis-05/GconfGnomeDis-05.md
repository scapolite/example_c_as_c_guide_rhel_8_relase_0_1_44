...
scapolite:
    class: rule
    version: '0.51'
id: gconf_gnome_disable_restart_shutdown
  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-gconf_gnome_disable_restart_shutdown_ocil:questionnaire:1
        href: gconf_gnome_disable_restart_shutdown.ocil.xml
crossrefs:
...
unknown, the ability shutdown or restart the system. This functionality
should be disabled by running the following:
