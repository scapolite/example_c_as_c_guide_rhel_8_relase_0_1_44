...
scapolite:
    class: rule
    version: '0.51'
id: gconf_gnome_disable_thumbnailers
  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-gconf_gnome_disable_thumbnailers_ocil:questionnaire:1
        href: gconf_gnome_disable_thumbnailers.ocil.xml
crossrefs:
...
An
attacker with knowledge of a flaw in a GNOME thumbnailer application
...
The
system\'s default desktop environment, GNOME, uses a number of different
thumbnailer programs to generate thumbnails for any new or modified
content in an opened folder. The following command can disable the
execution of these thumbnail applications:
