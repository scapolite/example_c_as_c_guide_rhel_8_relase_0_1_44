...
scapolite:
    class: rule
    version: '0.51'
id: dconf_gnome_screensaver_idle_activation_locked
  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: dconf_gnome_screensaver_idle_activation_locked.sh
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-dconf_gnome_screensaver_idle_activation_locked:def:1
        href: dconf_gnome_screensaver_idle_activation_locked.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-dconf_gnome_screensaver_idle_activation_locked_ocil:questionnaire:1
        href: dconf_gnome_screensaver_idle_activation_locked.ocil.xml
crossrefs:
