...
scapolite:
    class: rule
    version: '0.51'
id: gconf_gnome_screen_locking_keybindings
  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-gconf_gnome_screen_locking_keybindings_ocil:questionnaire:1
        href: gconf_gnome_screen_locking_keybindings.ocil.xml
crossrefs:
...
Run
the following command to prevent changes to the screensaver lock
keybindings:
