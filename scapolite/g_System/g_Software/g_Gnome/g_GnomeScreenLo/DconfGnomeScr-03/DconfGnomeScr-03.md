...
scapolite:
    class: rule
    version: '0.51'
id: dconf_gnome_screensaver_lock_locked
  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: dconf_gnome_screensaver_lock_locked.sh
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-dconf_gnome_screensaver_lock_locked:def:1
        href: dconf_gnome_screensaver_lock_locked.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-dconf_gnome_screensaver_lock_locked_ocil:questionnaire:1
        href: dconf_gnome_screensaver_lock_locked.ocil.xml
crossrefs:
  ...
  - system: http://iase.disa.mil/stigs/os/general/Pages/index.aspx
    idref: SRG-OS-000029-GPOS-00010
    relation: ''
---
