  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-service_nails_enabled_ocil:questionnaire:1
        href: service_nails_enabled.ocil.xml
crossrefs:
...
The
`nails` service is used to run McAfee VirusScan Enterprise for Linux and
McAfee Host-based Security System (HBSS) services. The `nails` service
