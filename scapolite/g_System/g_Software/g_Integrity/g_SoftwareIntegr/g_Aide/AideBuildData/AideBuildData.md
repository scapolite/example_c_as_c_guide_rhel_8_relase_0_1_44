  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: aide_build_database.sh
  - relative_id: '02'
    title: Automated fix
    automations:
      - system: urn:xccdf:fix:script:ansible
        href: aide_build_database.ansible
        complexity: low
        disruption: low
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-aide_build_database:def:1
        href: aide_build_database.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-aide_build_database_ocil:questionnaire:1
        href: aide_build_database.ocil.xml
crossrefs:
...
For
AIDE to be effective, an initial database of \"known-good\" information
about files must be captured and it should be able to be verified
against the installed files.

## /description

Run
the following command to generate a new database:
