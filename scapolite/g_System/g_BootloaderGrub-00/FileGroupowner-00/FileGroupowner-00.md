  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: file_groupowner_grub2_cfg.sh
        complexity: low
        disruption: low
  - relative_id: '02'
    title: Automated fix
    automations:
      - system: urn:xccdf:fix:script:ansible
        href: file_groupowner_grub2_cfg.ansible
        complexity: low
        disruption: low
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-file_groupowner_grub2_cfg:def:1
        href: file_groupowner_grub2_cfg.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-file_groupowner_grub2_cfg_ocil:questionnaire:1
        href: file_groupowner_grub2_cfg.ocil.xml
crossrefs:
...
The
file `/boot/grub2/grub.cfg` should be group-owned by the `root` group to
prevent destruction or modification of the file. To properly set the
group owner of `/boot/grub2/grub.cfg`, run the command:
