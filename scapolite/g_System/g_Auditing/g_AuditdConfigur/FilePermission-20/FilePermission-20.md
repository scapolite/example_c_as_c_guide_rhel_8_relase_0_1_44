  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: file_permissions_var_log_audit.sh
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-file_permissions_var_log_audit:def:1
        href: file_permissions_var_log_audit.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-file_permissions_var_log_audit_ocil:questionnaire:1
        href: file_permissions_var_log_audit.ocil.xml
crossrefs:
