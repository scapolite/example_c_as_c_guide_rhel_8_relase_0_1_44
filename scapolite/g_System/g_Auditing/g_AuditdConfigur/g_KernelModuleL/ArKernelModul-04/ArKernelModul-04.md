  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: audit_rules_kernel_module_loading_delete.sh
  - relative_id: '02'
    title: Automated fix
    automations:
      - system: urn:xccdf:fix:script:ansible
        href: audit_rules_kernel_module_loading_delete.ansible
        complexity: low
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-audit_rules_kernel_module_loading_delete:def:1
        href: audit_rules_kernel_module_loading_delete.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-audit_rules_kernel_module_loading_delete_ocil:questionnaire:1
        href: audit_rules_kernel_module_loading_delete.ocil.xml
crossrefs:
...
The
removal of kernel modules can be used to alter the behavior of the
...
To
capture kernel module unloading events, use following line, setting ARCH
