...
scapolite:
    class: rule
    version: '0.51'
id: audit_rules_kernel_module_loading_insmod
  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: audit_rules_kernel_module_loading_insmod.sh
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-audit_rules_kernel_module_loading_insmod:def:1
        href: audit_rules_kernel_module_loading_insmod.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-audit_rules_kernel_module_loading_insmod_ocil:questionnaire:1
        href: audit_rules_kernel_module_loading_insmod.ocil.xml
crossrefs:
...
To
capture invocation of insmod, utility used to insert modules into
kernel, use the following line:
