...
scapolite:
    class: rule
    version: '0.51'
id: audit_rules_kernel_module_loading_modprobe
  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: audit_rules_kernel_module_loading_modprobe.sh
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-audit_rules_kernel_module_loading_modprobe:def:1
        href: audit_rules_kernel_module_loading_modprobe.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-audit_rules_kernel_module_loading_modprobe_ocil:questionnaire:1
        href: audit_rules_kernel_module_loading_modprobe.ocil.xml
crossrefs:
...
To
capture invocation of modprobe, utility used to insert / remove modules
from kernel, add the following line:
