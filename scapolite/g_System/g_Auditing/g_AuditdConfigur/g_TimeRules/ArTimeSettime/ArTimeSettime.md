  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: audit_rules_time_settimeofday.sh
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-audit_rules_time_settimeofday:def:1
        href: audit_rules_time_settimeofday.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-audit_rules_time_settimeofday_ocil:questionnaire:1
        href: audit_rules_time_settimeofday.ocil.xml
crossrefs:
