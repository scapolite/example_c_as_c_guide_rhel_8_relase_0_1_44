  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: audit_rules_time_clock_settime.sh
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-audit_rules_time_clock_settime:def:1
        href: audit_rules_time_clock_settime.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-audit_rules_time_clock_settime_ocil:questionnaire:1
        href: audit_rules_time_clock_settime.ocil.xml
crossrefs:
