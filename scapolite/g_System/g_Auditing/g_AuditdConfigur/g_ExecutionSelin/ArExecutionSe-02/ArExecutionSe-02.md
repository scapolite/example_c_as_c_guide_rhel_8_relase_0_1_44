...
scapolite:
    class: rule
    version: '0.51'
id: audit_rules_execution_semanage
  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: audit_rules_execution_semanage.sh
  - relative_id: '02'
    title: Automated fix
    automations:
      - system: urn:xccdf:fix:script:ansible
        href: audit_rules_execution_semanage.ansible
        complexity: low
        disruption: low
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-audit_rules_execution_semanage:def:1
        href: audit_rules_execution_semanage.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-audit_rules_execution_semanage_ocil:questionnaire:1
        href: audit_rules_execution_semanage.ocil.xml
crossrefs:
...
`semanage` command for all users and root. If the `auditd` daemon is
