...
scapolite:
    class: rule
    version: '0.51'
id: audit_rules_login_events_tallylog
  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: audit_rules_login_events_tallylog.sh
  - relative_id: '02'
    title: Automated fix
    automations:
      - system: urn:xccdf:fix:script:ansible
        href: audit_rules_login_events_tallylog.ansible
        complexity: low
        disruption: low
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-audit_rules_login_events_tallylog:def:1
        href: audit_rules_login_events_tallylog.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-audit_rules_login_events_tallylog_ocil:questionnaire:1
        href: audit_rules_login_events_tallylog.ocil.xml
crossrefs:
  ...
  - system: http://iase.disa.mil/stigs/os/general/Pages/index.aspx
    ...
    relation: ''
  - system: http://iase.disa.mil/stigs/os/general/Pages/index.aspx
    idref: SRG-OS-000470-GPOS-00214
    relation: ''
  - system: http://iase.disa.mil/stigs/os/general/Pages/index.aspx
    idref: SRG-OS-000473-GPOS-00218
    relation: ''
  - system: org.scapolite.unknown
    idref: SRG-OS-000473-VMM-001930
    relation: ''
  - system: org.scapolite.unknown
    idref: SRG-OS-000470-VMM-001900
    relation: ''
  - system: https://nvd.nist.gov/cce/index.cfm
    idref: CCE-80720-6
    relation: ''
...
Manual
editing of these files may indicate nefarious activity, such as an
