  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: auditd_data_retention_admin_space_left_action.sh
  - relative_id: '02'
    title: Automated fix
    automations:
      - system: urn:xccdf:fix:script:ansible
        href: auditd_data_retention_admin_space_left_action.ansible
        complexity: low
        disruption: low
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-auditd_data_retention_admin_space_left_action:def:1
        href: auditd_data_retention_admin_space_left_action.oval.xml
        exports:
          - value_id_namespace: org.ssgproject.RHEL-8
            value_idref: var_auditd_admin_space_left_action
            variable_idref: oval:ssg-var_auditd_admin_space_left_action:var:1
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-auditd_data_retention_admin_space_left_action_ocil:questionnaire:1
        href: auditd_data_retention_admin_space_left_action.ocil.xml
crossrefs:
...
Administrators
should be made aware of an inability to record audit records. If a
separate partition or logical volume of adequate size is used, running
