  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: auditd_data_retention_num_logs.sh
  - relative_id: '02'
    title: Automated fix
    automations:
      - system: urn:xccdf:fix:script:ansible
        href: auditd_data_retention_num_logs.ansible
        complexity: low
        disruption: low
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-auditd_data_retention_num_logs:def:1
        href: auditd_data_retention_num_logs.oval.xml
        exports:
          - value_id_namespace: org.ssgproject.RHEL-8
            value_idref: var_auditd_num_logs
            variable_idref: oval:ssg-var_auditd_num_logs:var:1
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-auditd_data_retention_num_logs_ocil:questionnaire:1
        href: auditd_data_retention_num_logs.ocil.xml
crossrefs:
...
Determine
how many log files `auditd` should retain when it rotates logs. Edit the
file `/etc/audit/auditd.conf`. Add or modify the following line,
substituting *NUMLOGS* with the correct value of :
