  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: grub2_enable_selinux.sh
  - relative_id: '02'
    title: Automated fix
    automations:
      - system: urn:xccdf:fix:script:ansible
        href: grub2_enable_selinux.ansible
        complexity: low
        disruption: low
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-grub2_enable_selinux:def:1
        href: grub2_enable_selinux.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-grub2_enable_selinux_ocil:questionnaire:1
        href: grub2_enable_selinux.ocil.xml
crossrefs:
...
Disabling
a major host protection feature, such as SELinux, at boot time prevents
...
SELinux
can be disabled at boot time by an argument in `/etc/default/grub`.
