  ...
  - relative_id: '02'
    ...
    automations:
      - system: urn:xccdf:fix:script:ansible
        href: file_owner_etc_shadow.ansible
        complexity: low
        disruption: low
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-file_owner_etc_shadow:def:1
        href: file_owner_etc_shadow.oval.xml
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-file_owner_etc_shadow_ocil:questionnaire:1
        href: file_owner_etc_shadow.ocil.xml
crossrefs:
