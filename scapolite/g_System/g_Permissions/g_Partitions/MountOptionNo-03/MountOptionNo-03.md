  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: mount_option_noexec_removable_partitions.sh
  - relative_id: '02'
    title: Automated fix
    automations:
      - system: urn:xccdf:fix:script:ansible
        href: mount_option_noexec_removable_partitions.ansible
        complexity: low
        disruption: high
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-mount_option_noexec_removable_partitions:def:1
        href: mount_option_noexec_removable_partitions.oval.xml
        exports:
  ...
  - relative_id: '02'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-mount_option_noexec_removable_partitions_ocil:questionnaire:1
        href: mount_option_noexec_removable_partitions.ocil.xml
crossrefs:
...
Allowing
users to execute binaries from removable media such as USB keys exposes
