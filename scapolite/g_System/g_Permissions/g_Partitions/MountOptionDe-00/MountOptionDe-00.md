  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: mount_option_dev_shm_nosuid.sh
  - relative_id: '02'
    title: Automated fix
    automations:
      - system: urn:xccdf:fix:script:ansible
        href: mount_option_dev_shm_nosuid.ansible
        complexity: low
        disruption: high
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-mount_option_dev_shm_nosuid:def:1
        href: mount_option_dev_shm_nosuid.oval.xml
crossrefs:
...
programs in `/dev/shm`. The SUID and SGID permissions should not be
