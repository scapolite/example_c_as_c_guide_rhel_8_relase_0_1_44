...
Users should not be able to execute SUID or SGID binaries from user home
...
programs in `/home`. The SUID and SGID permissions should not be
required in these user data directories. Add the `nosuid` option to the
