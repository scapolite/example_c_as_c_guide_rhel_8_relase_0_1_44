  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: mount_option_dev_shm_nodev.sh
  - relative_id: '02'
    title: Automated fix
    automations:
      - system: urn:xccdf:fix:script:ansible
        href: mount_option_dev_shm_nodev.ansible
        complexity: low
        disruption: high
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-mount_option_dev_shm_nodev:def:1
        href: mount_option_dev_shm_nodev.oval.xml
crossrefs:
...
The
`nodev` mount option can be used to prevent creation of device files in
`/dev/shm`. Legitimate character and block devices should not exist
