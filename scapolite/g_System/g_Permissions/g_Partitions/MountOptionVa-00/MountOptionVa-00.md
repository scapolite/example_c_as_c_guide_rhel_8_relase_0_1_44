  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: mount_option_var_tmp_bind.sh
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-mount_option_var_tmp_bind:def:1
        href: mount_option_var_tmp_bind.oval.xml
crossrefs:
...
Having
multiple locations for temporary storage is not required. Unless
