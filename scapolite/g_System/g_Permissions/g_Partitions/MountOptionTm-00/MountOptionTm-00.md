  ...
  - relative_id: '01'
    ...
    automations:
      - system: urn:xccdf:fix:script:sh
        href: mount_option_tmp_nodev.sh
  - relative_id: '02'
    title: Automated fix
    automations:
      - system: urn:xccdf:fix:script:ansible
        href: mount_option_tmp_nodev.ansible
        complexity: low
        disruption: high
  - relative_id: '03'
    title: Automated fix
    automations:
      - system: urn:redhat:anaconda:pre
        href: mount_option_tmp_nodev.anaconda
        complexity: low
        disruption: high
checks:
  - relative_id: '01'
    automations:
      - system: http://oval.mitre.org/XMLSchema/oval-definitions-5
        idref: oval:ssg-mount_option_tmp_nodev:def:1
        href: mount_option_tmp_nodev.oval.xml
crossrefs:
