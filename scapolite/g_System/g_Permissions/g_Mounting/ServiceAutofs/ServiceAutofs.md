  ...
  - relative_id: '01'
    automations:
      - system: http://scap.nist.gov/schema/ocil/2
        idref: ocil:ssg-service_autofs_disabled_ocil:questionnaire:1
        href: service_autofs_disabled.ocil.xml
crossrefs:
  ...
  - system: http://iase.disa.mil/stigs/os/general/Pages/index.aspx
    ...
    relation: ''
  - system: http://iase.disa.mil/stigs/os/general/Pages/index.aspx
    idref: SRG-OS-000378-GPOS-00163
    relation: ''
  - system: http://iase.disa.mil/stigs/os/general/Pages/index.aspx
...
Disabling
the automounter permits the administrator to statically control
filesystem mounting through `/etc/fstab`.  
  
Additionally, automatically mounting filesystems permits easy
introduction of unknown devices, thereby facilitating malicious
activity.
